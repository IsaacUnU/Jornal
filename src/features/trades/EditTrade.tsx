...
import { Calendar, Activity, Brain, CheckCircle2, ArrowLeft } from 'lucide-react';
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-10">
            <header className="flex items-center gap-4">
                <button onClick={() => navigate(-1)} className="p-2 bg-[#111111] border border-[#222222] rounded-xl text-gray-400 hover:text-white">
                    <ArrowLeft className="w-5 h-5" />
                </button>
                <div>
                    <h2 className="text-3xl font-bold">{t.edit} {t.tradeDetail}</h2>
